...
CREATE TABLE `commit` (
  ...
  `lines_added` int(11) DEFAULT '0',
  `lines_deleted` int(11) DEFAULT '0',
  `lines_modified` int(11) DEFAULT '0',
...
INSERT INTO `commit` VALUES ('1','5','1','0',0,2,0,'2018-04-05','3'),('2','10','1','1',0,0,0,'2018-04-06','3'),('3','0','1','0',2,0,0,'2018-05-06','3'),('4','3','2','0',0,20,0,'2018-05-08','1'),('5','20','2','2',0,0,0,'2018-04-03','1');
...
INSERT INTO `issue` VALUES ('1','5','1','a','d','2018-04-06',NULL,NULL);
...
INSERT INTO `pull_request` VALUES ('1','20','1','ad','asdf','2018-05-06',NULL),('2','10','1','df','ewe','2018-04-08',NULL);
...
CREATE TABLE `user_repository` (
  ...
  `pull_request_number` int(11) DEFAULT NULL,
...
-- Dump completed on 2018-05-13 18:59:39
